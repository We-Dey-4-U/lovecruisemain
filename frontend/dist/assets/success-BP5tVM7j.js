import"./app-CKPtwmu4.js";/* empty css              */var e=new URLSearchParams(window.location.search),t=e.get(`tx_ref`),n=e.get(`status`);console.log(`[flw-success] tx_ref:`,t,`status param:`,n);var r=document.getElementById(`result-screen`);function i(){r.innerHTML=`
